...
HUB_LEAD = {
    'en': "Sixty years of Vilalara, celebrated at the table. In September, four guest "
          "chefs cook four hands with our own, one evening each. Tables set at dusk, "
          "the Atlantic close by, and nothing to do but stay.",
    'pt': "Sessenta anos de Vilalara, celebrados à mesa. Em setembro, quatro chefs "
          "convidados cozinham a quatro mãos com os nossos, uma noite cada. Mesas "
    ...
    'es': "Sesenta años de Vilalara, celebrados en la mesa. En septiembre, cuatro chefs "
          "invitados cocinan a cuatro manos con los nuestros, una noche cada uno. Mesas "
    ...
    'de': "Sechzig Jahre Vilalara, gefeiert bei Tisch. Im September kochen vier Gastköche "
          "vierhändig mit unseren eigenen, je einen Abend. Gedeckte Tische in der "
          "Dämmerung, der Atlantik ganz nah, und nichts zu tun außer zu bleiben.",
    'fr': "Soixante ans de Vilalara, célébrés à table. En septembre, quatre chefs invités "
          "cuisinent à quatre mains avec les nôtres, un soir chacun. Tables dressées au "
...
ROW = {
    'atlantico': {
        'en': "The sea, served without artifice. At Coral, João Viegas cooks four hands "
              "with Diogo Pereira, with coastal fish, shellfish at their peak, salt and "
              "acidity.",
        'pt': "O mar, servido sem artifício. No Coral, João Viegas cozinha a quatro mãos "
              "com Diogo Pereira, com peixe da costa, marisco no ponto, sal e acidez.",
        'es': "El mar, servido sin artificio. En Coral, João Viegas cocina a cuatro manos "
              "con Diogo Pereira, con pescado de costa, marisco en su punto, sal y acidez.",
        'de': "Das Meer, ohne Umschweife serviert. Im Coral kocht João Viegas vierhändig "
              "mit Diogo Pereira, mit Küstenfisch, Meeresfrüchten, Salz und Säure.",
        'fr': "La mer, servie sans artifice. Au Coral, João Viegas cuisine à quatre mains "
              "avec Diogo Pereira, poisson de côte, coquillages à point, sel et acidité.",
    },
    'fogo': {
        'en': "Embers, smoke and patience. At Raízes, Alexandre Silva cooks four hands "
              "with Telmo Pires over live fire, the oldest gesture in the kitchen.",
        'pt': "Brasa, fumo e paciência. No Raízes, Alexandre Silva cozinha a quatro mãos "
              "com Telmo Pires sobre fogo vivo, o gesto mais antigo da cozinha.",
        'es': "Brasa, humo y paciencia. En Raízes, Alexandre Silva cocina a cuatro manos "
              "con Telmo Pires sobre fuego vivo, el gesto más antiguo de la cocina.",
        'de': "Glut, Rauch und Geduld. Im Raízes kocht Alexandre Silva vierhändig mit "
              "Telmo Pires über offenem Feuer, der ältesten Geste der Küche.",
        'fr': "Braise, fumée et patience. Au Raízes, Alexandre Silva cuisine à quatre "
    ...
    'algarve': {
        'en': "A return to origin. At Praça das Rosas, Louis Anjos cooks with the three "
              "chefs of the house, between hills and sea. The night that closes the circle.",
        'pt': "Um regresso à origem. Na Praça das Rosas, Louis Anjos cozinha com os três "
              "chefs da casa, entre a serra e o mar. A noite que fecha o círculo.",
        'es': "Un regreso al origen. En Praça das Rosas, Louis Anjos cocina con los tres "
              "chefs de la casa, entre sierra y mar. La noche que cierra el círculo.",
        'de': "Eine Rückkehr zum Ursprung. Auf der Praça das Rosas kocht Louis Anjos mit "
              "den drei Chefs des Hauses, zwischen Hügeln und Meer. Der Abend, der den "
              "Kreis schließt.",
        'fr': "Un retour à l'origine. Sur la Praça das Rosas, Louis Anjos cuisine avec les "
              "trois chefs de la maison, entre collines et mer. Le soir qui boucle la "
              "boucle.",
    },
}
...
INTRO = {
    'atlantico': {
        'en': "The sea arrives before the wine. At Coral, João Viegas cooks four hands "
              "with Diogo Pereira, the guest and the head chef at the same pass. "
              "Shellfish opened to order, rice that will not be hurried, salt and acidity "
              "in balance. A table guided by what the tide left that morning.",
        'pt': "O mar chega antes do vinho. No Coral, João Viegas cozinha a quatro mãos com "
              "Diogo Pereira, o convidado e o chef da casa no mesmo passe. Marisco aberto "
              "na hora, arroz que não se apressa, sal e acidez em equilíbrio. Uma mesa "
              "guiada pelo que a maré deixou nessa manhã.",
        'es': "El mar llega antes que el vino. En Coral, João Viegas cocina a cuatro manos "
              "con Diogo Pereira, el invitado y el chef de la casa en el mismo pase. "
        ...
        'de': "Das Meer kommt vor dem Wein. Im Coral kocht João Viegas vierhändig mit "
              ...
              "Morgen zurückließ.",
        'fr': "La mer arrive avant le vin. Au Coral, João Viegas cuisine à quatre mains "
              "avec Diogo Pereira, l'invité et le chef de la maison au même passe. "
              "Coquillages ouverts à la minute, riz que rien ne presse, sel et acidité en "
              "équilibre. Une table guidée par ce que la marée a laissé ce matin-là.",
    },
    'fogo': {
    ...
    'algarve': {
        'en': "The last evening happens in the open air, at Praça das Rosas, with the sea "
              ...
              "kitchens all year, four at one pass rather than two. Between them, a whole "
              "region at the table, from the garden to the salt to the day's catch.",
        'pt': "A última noite acontece ao ar livre, na Praça das Rosas, com o mar a "
              ...
              "cozinhas do Vilalara todo o ano, quatro no mesmo passe em vez de dois. "
              "Entre eles, uma região inteira à mesa, da horta ao sal ao que o dia trouxe.",
        'es': "La última noche sucede al aire libre, en Praça das Rosas, con el mar "
              ...
              "cocinas de Vilalara todo el año, cuatro en el mismo pase en vez de dos. "
              "Entre ellos, una región entera en la mesa, de la huerta a la sal a lo que "
              "trajo el día.",
        'de': "Der letzte Abend findet unter freiem Himmel statt, auf der Praça das Rosas, "
              "während das Meer unten dunkel wird. Louis Anjos kocht mit den drei Chefs, "
              "die Vilalaras Küchen das ganze Jahr führen, vier an einem Pass statt zwei. "
              "Zwischen ihnen eine ganze Region bei Tisch, vom Garten über das Salz bis "
              "zum Fang des Tages.",
        'fr': "La dernière soirée se passe en plein air, sur la Praça das Rosas, la mer "
              ...
              "tiennent les cuisines de Vilalara toute l'année, quatre au même passe "
              "plutôt que deux. Entre eux, une région entière à table, du potager au sel "
              "jusqu'à la pêche du jour.",
    },
}
